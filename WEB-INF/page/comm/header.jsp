				...
				<form class="form-horizontal" role="form" action="">
					...
					<div class="form-group has-feedback">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" value="${password}"
								id="loginPassword" placeholder="请输入密码" onblur="mdjia()"> <span
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<div class="checkbox">
								<label> <input value="1" <c:if test="${!empty password}"> checked </c:if>  id="isRemember" type="checkbox">请记住我
								</label>
							</div>
						</div>
					</div>
					...
					<div class="form-group has-feedback">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" id="regPassword"
								required name="password" onblur="mdjia()" placeholder="密码长度6-8位" min="6"
								maxlength="8"> <span
								class="glyphicon glyphicon-lock form-control-feedback"></span>
						</div>
